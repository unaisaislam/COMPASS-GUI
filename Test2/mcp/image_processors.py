...
class ImageProcessor(QObject):
    def __init__(self, img_path, output_csv):
        super().__init__()
        self.img_path = img_path
        self.output_csv = output_csv

    @pyqtSlot(str)
    def binarize(self, image_path: str):
    ...
    @pyqtSlot(str)
    def skeletonize(self, image_path: str):
        '''
        Binarizes the image depending on the mask value (0 for image grayscale < threshold, 1 for image grayscale > threshold), skeletonizes the image, and extracts Skeletonized Graph.
        '''
        img = io.imread(image_path)
        gray = color.rgb2gray(img)
        threshold = filters.threshold_otsu(gray)
    ...
    @pyqtSlot(str)
    def extractgraph(self, image_path: str):
        '''
        Binarizes the image depending on the mask value (0 for image grayscale < threshold, 1 for image grayscale > threshold), skeletonizes the image, and extracts a Colored-Component Skeleton Graph.
        '''
        img = io.imread(image_path)
        gray = color.rgb2gray(img)
        threshold = filters.threshold_otsu(gray)
    ...
    # number of nodes
    @pyqtSlot(str)
    def nodes(self, image_path: str):
        '''
        Returns the number of nodes in a skeletonized image.
        Skeleton requires a mask value to determine if the grayscale of the image is above or below the threshold.
    ...
    #edge-node graph
    @pyqtSlot(str)
    def en_graph(self, image_path: str):
    ...
    # graph density
    @pyqtSlot(str)
    def graphdens(self, image_path: str):
        '''
    ...
    # degree heatmap
    @pyqtSlot(str)
    def deg_hm(self, image_path: str):
        '''
    ...
    @pyqtSlot(str)
    def edge_lenwid(self, image_path: str, output_csv):
        '''
        ...
        edges_df.to_csv(output_csv, index=False, float_format="%.2f")
    ...
    def allpdfs(self):
        ...
        Mask value must be 0 (binary < threshold) or 1 (binary > threshold)
        '''
        with PdfPages(f"{image_path} figures.pdf") as pdf:
            # binary
    ...
    # node radii
    @pyqtSlot(str, str)
    def node_rad(self, image_path: str, output_csv: str):
        '''
        ...
        nodes_df.to_csv(output_csv, index=False, float_format="%.2f")
        print(f"Saved node radius map to {output_csv}")
